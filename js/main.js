 ...
 *
****************************************************************************************************/
MATTMOYA.slideDownHead = function(option){
	if(option){
...
/****************************************************************************************************
 * jquery for fade-in background pics
 *
 *
 *
****************************************************************************************************/
$(document).ready(function() {
  $('img').onScroll(function() {
 ...
 *
****************************************************************************************************/
MATTMOYA.parallax = function(option){
 ...
 *
****************************************************************************************************/
MATTMOYA.slider = function(selector, options){
 ...
 *
****************************************************************************************************/
MATTMOYA.owlCarousel = function (options){
 ...
 *
****************************************************************************************************/
MATTMOYA.skillbar = function(animated){
 ...
 *
****************************************************************************************************/
MATTMOYA.videoBgYT = function(selector,video){
	if(!Modernizr.touch){
 ...
 *
****************************************************************************************************/
MATTMOYA.bootstrapCarousel = function (options){
 ...
 *
****************************************************************************************************/
MATTMOYA.fitVids = function (selector){
	$(selector).fitVids();
};
/****************************************************************************************************
 * PORTFOLIO FILTER
...
MATTMOYA.portfolioFilter = function (selector, item){
...
MATTMOYA.portfolio = function (selector,options){
 ...
 *
****************************************************************************************************/
MATTMOYA.scrollAnim = function(option){
		$(window).load(function() {
			if(option == "yes"){
 ...
 *
****************************************************************************************************/
MATTMOYA.magnific = function (options){
